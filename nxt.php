      ...
      <div class="container-fluid">
        <div class="row" align-items-center>
          <div class="col-md-2">
            <div class="logo">
              <a href="welcome.php">
                <img src="logo_.png" height="80px" width="180px">
              </a>
            </div>
          </div>
          <!-- nav -->
          <div class="col-md-10">
            <nav>
              <!-- language -->
              <div class="lan">
                <div class="en"><strong>EN</strong></div>
                <div class="bn"><strong>BN</strong></div>
              </div>
              <!-- cart -->
              <div class="cart">
                <a href="cart.html">
                  <svg xmlns="http://www.w3.org/2000/svg" width="26" height="25" fill="currentColor" class="bi bi-clipboard-check-fill" viewBox="0 0 16 16">
        ...
        <div class="row">
          <div class="footer-col">
            ...
            <ul>
              ...
              <li><a href="#">VIP Client Program</a></li>
            </ul>
          </div>
          <div class="footer-col">
            <h4>Get Help</h4>
